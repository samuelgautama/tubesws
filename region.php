...
SELECT ?band_name ?asal ?about ?link WHERE {
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                foreach ($result as $row) {
                    echo "<div data-aos='fade-right' data-aos-duration='1000' class='card lg:card-side bg-base-100 shadow-xl'>
                    <div class='card-body'>
                    <img data-aos='flip-left' data-aos-duration='1000' class='w-32 h-48 w-48 rounded-lg' src='"
